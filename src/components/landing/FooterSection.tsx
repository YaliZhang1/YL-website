...
export const FooterSection = () => {
  ...
  const services = [
    ...
    { name: "IT Outsourcing", icon: Settings },
    { name: "Executive Recruitment", icon: Search },
    { name: "System Design", icon: Users }
  ];

  const quickLinks = [
    "About Us", "Portfolio", "Case Studies", "Blog", "Careers", "Contact"
  ];
  ...
  return (
    <footer className="relative bg-nordic-bg text-nordic-text bg-gradient-to-b from-gray-50 to-white  overflow-hidden">
      {/* 背景装饰 */}
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl pt-20 pb-12">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-8">
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-50 to-indigo-50 mb-6">
                  ...
                  <span className="font-semibold text-blue-700">Nordic Tech</span>
                </div>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Delivering world-class technology solutions with Scandinavian excellence. 
            ...
            <div>
              ...
              <div className="mt-8">
                <h4 className="text-sm font-medium text-gray-700 mb-4">Technologies</h4>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                Subscribe to our newsletter for the latest tech insights and Nordic innovation stories.
              </p>
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  {[
                    ...
                    { icon: Github, color: "hover:text-gray-800", bg: "hover:bg-gray-50" },
        ...
        {/* 分割线 */}
        <div className="mx-8 md:mx-16 lg:mx-24 max-w-7xl mx-auto">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-6">
              <span className="text-sm text-gray-500 hover:text-blue-600 cursor-pointer transition-colors duration-300">
                Privacy Policy
              </span>
              <span className="text-sm text-gray-500 hover:text-blue-600 cursor-pointer transition-colors duration-300">
                Terms of Service
        ...
        {/* 底部装饰渐变 */}
        <div className="h-2 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-blue-500/10" />
      </div>
    </footer>
  );
};
