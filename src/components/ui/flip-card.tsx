...
export default function CardFlip({
  ...
  return (
    <div
      ...
      className="group relative h-[360px] w-full max-w-[600px] [perspective:2000px]"
              ...
              {[...Array(6)].map((_, i) => (
                ...
                <div
                  ...
                  className={cn(
                    ...
                    "from-primary/30 via-primary/80 to-primary/30 bg-gradient-to-r",
                ...
                // <div
                //   key={i}
                //   className="h-4 w-full rounded-md animate-[slideIn_3.5s_ease-in-out_infinite]"
                //   style={{
                //     background:
                //       "linear-gradient(90deg, #38bdf8CC 0%, #f472b6DD 50%, #38bdf8CC 100%)", // 浅蓝-粉-浅蓝
                //     width: `${60 + Math.random() * 35}%`,
                //     animationDelay: `${i * 0.4}s`,
                //     marginLeft: `${Math.random() * 10}%`,
                //   }}
