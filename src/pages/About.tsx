...
import { 
  Users, Target, Lightbulb, Award, 
  MapPin, Calendar, TrendingUp, Heart,
  Code2, Zap, Shield, Globe,
  ChevronRight, Star, Coffee
} from "lucide-react";
  ...
  const values = [
    {
      icon: Shield,
      title: "Quality First",
      description: "We never compromise on quality. Every line of code is crafted with precision and tested thoroughly to ensure reliability and performance.",
      color: "from-blue-500 to-indigo-500"
    },
    {
      icon: Heart,
      title: "Human-Centered",
      description: "Technology should serve people, not the other way around. We design solutions that enhance human experiences and create meaningful connections.",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: Lightbulb,
      title: "Innovation Driven",
      description: "We embrace cutting-edge technologies and methodologies to solve complex problems and push the boundaries of what's possible.",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: Globe,
      title: "Sustainable Future",
      description: "Every project contributes to a better tomorrow. We consider environmental impact and long-term sustainability in all our decisions.",
  ...
  const milestones = [
    {
      ...
      description: "Started with a vision to bring Nordic design principles to the tech world",
      icon: Calendar
    },
    {
      year: "2012",
      title: "First Major Client",
      description: "Delivered our first enterprise solution for a Fortune 500 company",
      icon: Target
    },
    {
      year: "2016",
    ...
    },
    {
      ...
      description: "Pioneered distributed work model before it became mainstream",
      icon: Globe
    },
    {
      year: "2023",
      title: "AI Innovation Lab",
      description: "Launched dedicated R&D division focusing on AI and machine learning",
      icon: Lightbulb
    },
    {
      year: "2025",
      title: "Carbon Neutral",
      description: "Achieved carbon neutrality across all operations and projects",
      icon: Shield
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                We're a Stockholm-based technology company that combines Scandinavian design 
                principles with cutting-edge development practices to create solutions that 
              ...
              return (
                <div
                  ...
                  className={`group relative bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-100/50 p-8 shadow-lg shadow-gray-900/5 hover:shadow-xl hover:shadow-gray-900/10 transition-all duration-500 hover:-translate-y-2 cursor-pointer ${
                    activeValue === index ? 'ring-2 ring-blue-200 shadow-blue-500/20' : ''
                  }`}
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 bg-gradient-to-br ${value.color.replace('500', '50')} transition-opacity duration-500`} />
                </div>
              );
            })}
          </div>
                ...
                return (
                  <div key={index} className={`relative flex items-center ${isEven ? 'justify-start' : 'justify-end'}`}>
                    ...
                    <div className={`w-5/12 ${isEven ? 'pr-16' : 'pl-16'}`}>
                      <div className={`group bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100/50 p-6 shadow-lg shadow-gray-900/5 hover:shadow-xl hover:shadow-gray-900/10 transition-all duration-300 hover:-translate-y-1 ${
                        isEven ? 'text-right' : 'text-left'
                      }`}>
                        <div className={`flex items-center mb-4 ${isEven ? 'justify-end' : 'justify-start'}`}>
                          <div className={`p-2 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg ${isEven ? 'ml-3' : 'mr-3'}`}>
      ...
      <div className="py-20 bg-gradient-to-br from-gray-50/50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A diverse group of passionate professionals united by a shared vision 
              of creating exceptional digital experiences.
            </p>
          </div>
      ...
      <div className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl relative z-10 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            ...
            and Nordic approach to technology.
          </p>
