...
const About = () => {
  ...
  const milestones = [
    ...
    },
    {
      ...
      icon: Shield,
      image:
        "https://images.unsplash.com/photo-1569163139394-de4e4f43e4e3?w=400&h=300&fit=crop&crop=center&auto=format&q=80",
    },
  ];
        ...
        <main className="relative overflow-hidden pt-24">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 z-0">
              ...
              />
              {/* <div className="absolute inset-0 bg-gradient-to-b from-nordic-bg to-white dark:to-nordic-bg" /> */}
            </div>

            {/* 装饰性背景元素 */}
            <div className="absolute top-0 left-0 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl -translate-x-48 -translate-y-48 z-1" />
            <div className="absolute top-1/4 right-0 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl translate-x-40 z-1" />

            <div className="relative z-10 container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl pt-20 pb-32">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h1 className="text-5xl text-card md:text-6xl font-bold text-text mb-8 leading-tight">
                    Crafting Digital
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 block">
                      Excellence
                    </span>
                  ...
                  <p className="text-xl text-card mb-8 leading-relaxed">
                    We're a Stockholm-based technology company that combines
                    Scandinavian design principles with cutting-edge development
                    practices to create solutions that are both beautiful and
                    functional.
          ...
          <div className="absolute inset-0 z-0">
            ...
            />
            {/* <div className="absolute inset-0 bg-gradient-to-br from-gray-50/90 to-white/95" /> */}
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {values.map((value, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`group relative overflow-hidden bg-white/90 backdrop-blur-sm rounded-3xl border border-gray-100/50 shadow-lg shadow-gray-900/5 hover:shadow-xl hover:shadow-gray-900/10 transition-all duration-500 hover:-translate-y-2 cursor-pointer ${
                        activeValue === index
                          ? "ring-2 ring-blue-200 shadow-blue-500/20"
                          : ""
                      }`}
          ...
          <div className="py-20 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
              ...
              />
              {/* <div className="absolute inset-0 bg-gradient-to-b from-bg to-bgSecondary " /> */}
            </div>
            ...
            <div className="container mx-auto px-8 md:px-16 lg:px-24 max-w-7xl relative z-10">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-nordic-muted max-w-3xl mx-auto">
              ...
              <div className="relative">
                ...
                <div className="absolute left-1/2 transform -translate-x-0.5 w-1 h-full bg-gradient-to-b from-blue-400 via-indigo-400 to-purple-400 rounded-full shadow-lg" />
                  ...
                  {milestones.map((milestone, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full border-4 border-white shadow-xl z-10">
                          ...
                          >
                            ...
                            <div className="relative h-48 overflow-hidden">
                              ...
                              <div
                                ...
                                } bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl`}
                              >
                                <span className="text-2xl font-bold text-blue-600">
                                  {milestone.year}
                                </span>
                              ...
                              <div
                                className={`absolute bottom-4 ${
                                  isEven ? "right-4" : "left-4"
                                } p-3 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl text-white shadow-lg`}
                              >
